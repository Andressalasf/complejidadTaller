...
public class Tablero { //1
    ...
    private int vaciasEnFila(int f) { //1  -->  (5n+5) ; O(n)
        int n=0; //1
    ...
    private int vaciasEnColumna(int c) { //1  -->  (5n+5) ; O(n)
        int n=0; //1
        for(int f=0;f<FIL;f++) { // n+1
            if(tablero[f][c]==0) { //n
                n++; //n
    ...
    private int vacias() { //1  --> (5n**2+3n+5) ; o(n**2)
        int n=0; //1
        for(int f=0;f<FIL;f++) { //n+1
            for(int c=0;c<COL;c++) { // (n+1)*n --> n**2+n
    ...
    private void ponerDos() { //1  --> (11n+13) ; o(n)
        int f; //1
        int c; //1
    ...
    public void mostrar() { // 1   -->   (9n**3+29n**2+24n+9); o(n**3)
        for(int f=0;f<FIL;f++) { // n+1
        ...
        dibujaLineaHorizontal(); // 1 + (3n**2+4n+5) = 3n**2+4n+6
    } // 1 
    
    private void dibujaLineaHorizontal() { //1   -->  (3n**2+4n+5) ; o(n**2)
    ...
    private void dibujaEspacioHorizontal() { //1  -->   ( 3n**2+4n+5) ; o(n**2)
         System.out.print("|"); //1
        for(int c=0;c<COL;c++) { // n+1
            for(int i=0;i<12;i++) { // (n+1)*n --> n**2+n
                System.out.print(" "); // n**2
    ...
    public boolean ganador() { //1 --> (4n**2 +3n + 4) ; o(n**2)
        for(int f=0;f<FIL;f++) {    //n+1      
            for(int c=0;c<COL;c++) {  // (n+1) * n --> n**2+n
    ...
    public boolean finPartida() { //1 --> (9n**2+6n+12) ; o(n**2)
        return (ganador() || vacias()==0); // 1 + (4n**2 +3n + 4) + (5n**2+3n+5) --> 9n**2+6n+10
    } // 1
    
    public void moverArriba() { // 1 --> (12n**3+10n**2+54n+30) ; o(n**3)
        for(int c=0; c<COL; c++) { //n+1
    ...
    private void moverArribaColumna(int c) { // 1 --> (12n**2+1n+35) ; o(n**2)
        colocarArriba(c); // 1+ (6n**2-5n+14) = 6n**2-5n+15
        sumarArriba(c); // 1+ (11n+4) = 11n+5
        colocarArriba(c); //  1+ (6n**2-5n+14) = 6n**2-5n+15
    }
    
    private void colocarArriba(int c) { // 1  --> (6n**2-5n+14) ; o (n**2)
    ...
    private void sumarArriba(int c) { // 1 (11n+4) ; o(n)
    ...
    public void moverAbajo() { // 1 --> (12n**3+10n**2+54n+30) ; o(n**3)
        for(int c=0; c<COL; c++) { // n+1
    ...
    private void moverAbajoColumna(int c) { // 1 --> (12n**2+1n+35) ; o(n**2)
        colocarAbajo(c); // 1 + (6n**2-5n+14) = 6n**2-5n+15
        sumarAbajo(c); // 1+ (11n+4) = 11n+5
        colocarAbajo(c); //  1 + (6n**2-5n+14) = 6n**2-5n+15
    }
    
    private void colocarAbajo(int c) { // 1 --> (6n**2-5n+14) ; o(n**2)
    ...
    private void sumarAbajo(int c) { // 1 --> (11n+4) ; o(n)
    ...
    public void moverDerecha() { // 1 --> (12n**3+10n**2+54n+30) ; o(n**3)
    ...
    private void moverDerechaFila(int f) { // 1 --> (12n**2+1n+35) ; o(n**2)
        colocarDerecha(f); // 1 + (6n**2-5n+14) = 6n**2-5n+15
        sumarDerecha(f); // 1 + (11n+4) = 11n+5
        colocarDerecha(f); // 1 + (6n**2-5n+14) = 6n**2-5n+15
    }
    
    private void colocarDerecha(int f) { // 1 --> (6n**2-5n+14) ; o(n**2)
    ...
    private void sumarDerecha(int f) { // 1 --> (11n+4) ; o(n)
    ...
    public void moverIzquierda() { //1 --> (12n**3+10n**2+54n+30) ; o (n**3)
        for(int f=0; f<FIL; f++) { // n+1
    ...
    private void moverIzquierdaFila(int f) { // 1 --> (12n**2+1n+35) ; o(n**2)
        colocarIzquierda(f); // 1 + (6n**2-5n+14) = 6n**2-5n+15
        sumarIzquierda(f); // 1 + (11n+4) = 11n+5
        colocarIzquierda(f); // 1 + (6n**2-5n+14) = 6n**2-5n+15
    }
    
    private void colocarIzquierda(int f) { //1 (6n**2-5n+14) ; o(n**2)
    ...
    private void sumarIzquierda(int f) { //1   (11n+4) ; o(n)
